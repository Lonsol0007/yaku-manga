package yaku.data.backup.restore
...
import yaku.data.backup.BackupDecoder
import yaku.data.backup.BackupNotifier
...
import yaku.data.backup.restore.restorers.CategoriesRestorer
import yaku.data.backup.restore.restorers.ExtensionStoreRestorer
import yaku.data.backup.restore.restorers.MangaRestorer
import yaku.data.backup.restore.restorers.PreferenceRestorer
    ...
    private fun writeErrorLog(): File {
        try {
            if (errors.isNotEmpty()) {
                val file = context.createFileInCacheDir("yaku_restore_error.txt")
