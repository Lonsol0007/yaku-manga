...
import yaku.extension.installer.Installer
import yaku.extension.installer.PackageInstallerInstaller
import yaku.extension.installer.ShizukuInstaller
import yaku.extension.util.ExtensionInstaller.Companion.EXTRA_DOWNLOAD_ID
import yaku.i18n.MR
...
class ExtensionInstallService : Service() {
    ...
    override fun onCreate() {
        val notification = notificationBuilder(Notifications.CHANNEL_EXTENSIONS_UPDATE) {
            setSmallIcon(R.drawable.ic_yaku)
            setAutoCancel(false)
            setOngoing(true)
            setShowWhen(false)
