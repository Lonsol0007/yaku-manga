package yaku.presentation.category.components
...
import yaku.core.preference.asToggleableState
...
fun ChangeCategoryDialog(
    ...
    if (initialSelection.isEmpty()) {
        AlertDialog(
            onDismissRequest = onDismissRequest,
            confirmButton = {
                yaku.presentation.core.components.material.TextButton(
                    onClick = {
                        onDismissRequest()
                        onEditCategories()
                    },
    ...
    AlertDialog(
        ...
        confirmButton = {
            Row {
                yaku.presentation.core.components.material.TextButton(onClick = {
                    onDismissRequest()
                    onEditCategories()
                }) {
                ...
                yaku.presentation.core.components.material.TextButton(onClick = onDismissRequest) {
                    Text(text = stringResource(MR.strings.action_cancel))
                }
                yaku.presentation.core.components.material.TextButton(
                    onClick = {
