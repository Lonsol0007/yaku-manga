package yaku.presentation.more.settings
...
import yaku.presentation.core.components.BaseSliderItem
import yaku.presentation.core.util.collectAsState
import yaku.presentation.more.settings.widget.EditTextPreferenceWidget
import yaku.presentation.more.settings.widget.InfoWidget
import yaku.presentation.more.settings.widget.ListPreferenceWidget
import yaku.presentation.more.settings.widget.MultiSelectListPreferenceWidget
import yaku.presentation.more.settings.widget.PrefsHorizontalPadding
import yaku.presentation.more.settings.widget.PrefsVerticalPadding
import yaku.presentation.more.settings.widget.SwitchPreferenceWidget
import yaku.presentation.more.settings.widget.TextPreferenceWidget
import yaku.presentation.more.settings.widget.TitleFontSize
import yaku.presentation.more.settings.widget.TrackingPreferenceWidget
