...
import yaku.core.migration.Migrator
...
import yaku.domain.source.interactor.GetIncognitoState
import yaku.extension.api.ExtensionApi
import yaku.feature.support.SupportUsScreen
import yaku.i18n.MR
import yaku.presentation.components.AdaptiveSheet
import yaku.presentation.components.AppStateBanners
import yaku.presentation.components.DownloadedOnlyBannerBackgroundColor
import yaku.presentation.components.IncognitoModeBannerBackgroundColor
import yaku.presentation.components.IndexingBannerBackgroundColor
...
import yaku.presentation.more.settings.screen.browse.ExtensionStoresScreen
import yaku.presentation.more.settings.screen.data.RestoreBackupScreen
import yaku.presentation.util.AssistContentScreen
import yaku.presentation.util.DefaultNavigatorScreenTransition
...
import yaku.ui.deeplink.DeepLinkScreen
import yaku.ui.home.HomeScreen
import yaku.ui.manga.MangaScreen
import yaku.ui.more.NewUpdateScreen
import yaku.ui.more.OnboardingScreen
import yaku.ui.setting.SettingsScreen
...
class MainActivity : BaseActivity() {
    ...
    private fun ShowDonationCampaign() {
        ...
        // Yaku Manga does not solicit donations, and must never show upstream's fundraising
        // appeal: it names Mihon's developer and links Mihon's Patreon, which would be
        // misleading coming from a fork. The composable above is left intact so the upstream
        // diff stays small if Yaku Manga ever runs a campaign of its own.
        LaunchedEffect(Unit) {
            showCampaign = false
        }
    }
    ...
    companion object {
        const val INTENT_SEARCH = "yaku.SEARCH"
